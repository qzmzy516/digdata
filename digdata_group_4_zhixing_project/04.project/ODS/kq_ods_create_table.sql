drop table if exists zx_ods.t_class_studying_student_count;
create table zx_ods.t_class_studying_student_count
(
    id                     int,
...
drop table if exists zx_ods.t_course_table_upload_detail;
create table zx_ods.t_course_table_upload_detail
(   id                  int          comment 'id',
...
drop table if exists zx_ods.t_student_leave_apply;
create table zx_ods.t_student_leave_apply
(
    id              int ,
    class_id        int               comment '班级id',
...
drop table if exists zx_ods.t_tbh_class_time_table;
create table zx_ods.t_tbh_class_time_table
(
    id                    int               comment '主键id',
    class_id              int               comment '班级id',
...
drop table if exists zx_ods.t_tbh_student_signin_record;
create table zx_ods.t_tbh_student_signin_record
(
    id                int                 comment '主键id',
